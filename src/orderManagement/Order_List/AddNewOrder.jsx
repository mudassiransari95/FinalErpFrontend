...
<div className=' w-96  sub-div ms-2 mt-4  flex flex-col gap-2'> 
<div className='  h-96  flex flex-row' style={{width:""}}>
<div id="uploadone" name="im" className="   relative">
    <label className='w-80 h-56 mt-3 ' id="uploadone">    Upload Item Image 
  <input  onChange={handleuploadImage} hidden  type="file"  id="uploadone" accept="image/*" placeholder='helllllllllllllllllllllllllllllllll' className="" data-id="image" />
