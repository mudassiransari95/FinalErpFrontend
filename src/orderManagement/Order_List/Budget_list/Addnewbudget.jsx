...
<p htmlFor="upload" className="upload-img mt-2">
  ...
  <input onChange={handleuploadImage} type="file" name="image" id="upload" accept="image/*" className="d-none file-input-change" data-id="image" />
...
<div className=' w-full  flex h-20 mb-10 my-10 '>
    <div className=' w-96 mt-3 flex flex-row gap-3 ms-96'>
    <Link to={'/budget_list'} className=' btn btn-join w-48 h-11 bg-white' style={{borderRadius:"5px",border:"1px solid black"}}>Cancel</Link>
