...
const AddNewAdmin = ({ onAdminCreated }) => {
  ...
  <div  className="col-md-4 relative" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
    ...
    <img
      ...
      alt=""
    />
    <input onChange={handleuploadImage}  id="image" type="file" className="mt-3" />
    </label>
  </div>
</div>
