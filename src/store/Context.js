...
console.log('superadmin',superadmin)
  ...
  return (
    <createcontext.Provider value={{ SuperAdminData, superadminid,superadmin,setsuperadmin,setadmin,admin,setmarchendiser,marchendiser,accountant, setaccountant,production, setproduction,commercial,setcommercial,manager,setmanager,setbuyer,buyer}}>
      {props.children}
